...
js=js.slice(0,btStart)+headerEnhancements+'\n'+js.slice(btEnd);
...
hero=hero.replace('children:[o.jsxs("div",{className:"ed-hero-copy"','children:[o.jsx("div",{className:"spectrum-field","aria-hidden":"true",children:o.jsx("video",{src:"/assets/hero-gradient-loop.mp4?v=figma-palette",autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"auto"})}),o.jsxs("div",{className:"ed-hero-copy"');
